...
MODEL_FOR_RNNT_MAPPING_NAMES = OrderedDict(
    [
        # Model for Recurrent Neural Network Transducer (RNN-T) mapping.
        ("nemotron_asr", "NemotronAsrForRNNT"),
    ]
)
...
AutoModelForRNNT = auto_class_update(AutoModelForRNNT, head_doc="recurrent neural network transducer")
